...
from vis import RAINFALL_LEVELS
...
def _get_colorlist(units='mm/h', colorscale='pysteps'):
    ...
    if colorscale == "BOM-RF3":
        ...
        redgreyHex = '#%02x%02x%02x' % (255, 255, 255)
        color_list = [redgreyHex, "#e6e6ff", "#b6b6f4", "#79e1ea", "#0064FF", "#3232C8","#009696","#00C832",
        ...
        if units in ['mm/h', 'mm']:
            ...
            # clevs= [0.00,0.02,0.05,0.08,0.16,0.25, 0.4, 0.63,1,1.6,2.5,4.0,6.3,10,16,25,40]
            clevs= RAINFALL_LEVELS
        elif units == 'dBZ':
